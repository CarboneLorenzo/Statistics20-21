...
namespace CSharp
{
    public partial class Form1 : Form
    {
        ...
        private void representPath()
        {
            ...
            for (int i = 1; i<=m; i++)
            {
                ...
                for (int j = 1; j<=n; j++)
                {
                    ...
                    double normalValue = NextStandardGaussianDouble(mu*t, sigma, r);
        ...
        private double NextStandardGaussianDouble(double mean, double stdDev, Random r)
        {
        ...
        {
            sigma = (double)numericUpDown3.Value;
        }
        ...
        {
            mu = (double)numericUpDown4.Value;
        }
    }
}
